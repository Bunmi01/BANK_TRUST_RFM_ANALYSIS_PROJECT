...
def main():
    ...
    # Calculate RFM scored
    rfm_data = calculate_rfm_scores(rfm_data)

    # FIX: send only metric columns (exactly like colab)
    ...
    with tab2:
        ...
        st.download_button(
            ...
            data=csv_data,
            file_name='rfm_segmented_customer.csv',
            mime = "text/csv"
        )
    ...
    with tab3:
        ...
        Give recommendation to improve revenue, customer retention and engagement.
        """
